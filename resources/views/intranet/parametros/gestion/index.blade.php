            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-md-6 col-lg-6 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                    @if ($permiso == null || $permiso->guardar)
                        <a href="{{ route('admin-gestion-crear') }}" class="btn btn-success btn-sm text-center pl-3 pr-3"
                            style="font-size: 0.9em;"><i class="fas fa-plus-circle mr-2"></i> Nueva Gestión</a>
                    @endif
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($permiso == null || $permiso->actualizar == 1)
                                                    <a href="{{ route('admin-gestion-editar', ['id' => $gestion->id]) }}"
                                                        class="btn-accion-tabla tooltipsC text-info" title="Editar"><i
                                                            class="fa fa-edit" aria-hidden="true"></i></a>
                                                @endif
                                                @if ($permiso == null || $permiso->borrar == 1)
                                                    <form
                                                        action="{{ route('admin-gestion-eliminar', ['id' => $gestion->id]) }}"
