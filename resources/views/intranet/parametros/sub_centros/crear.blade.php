        ...
        <div class="card-header">
            <div class="row mb-3">
                ...
                <div class="col-12 col-md-6 col-lg-6 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                    <a href="{{ route('admin-sub_centros_costo') }}"
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin-sub_centros_costo-guardar') }}" class="form-horizontal row"
                        method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="card-body">
                            @include('intranet.parametros.sub_centros.form')
                        </div>
                        <!-- /.card-body -->
