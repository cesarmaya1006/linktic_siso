    ...
    <div class="card">
        ...
        <div class="card-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="m-0">Editar Dependencia</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Dependencias - Editar</li>
                        </ol>
                    </div>
                </div>
                <div class="row mb-3">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('dependencias-actualizar',['id' => $dependencia->id]) }}" class="form-horizontal row"
