...
@section('cuerpo_pagina')
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="card-title">Nueva Característica</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('admin-matriz_caracteristicas-guardar') }}" class="form-horizontal" method="POST">
            @csrf
            @method('post')
            <div class="card-body">
                @include('intranet.empresa.caracteristicas.form')
            </div>
            <!-- /.card-body -->
