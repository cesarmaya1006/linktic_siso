...
@section('cuerpo_pagina')
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button
                                            ...
                                            data-bs-target="#compPropiosModal"
                                    ...
                                    <td class="text-center">
                                        <button
                                            data-bs-toggle="modal"
                                            data-bs-target="#compRentadosModal"
                                    ...
                                    <td class="text-center">
                                        <button
                                            data-bs-toggle="modal"
                                            data-bs-target="#impresorasModal"
    ...
    <!-- Modal -->
    <div class="modal fade" id="compRentadosModal" tabindex="-1" aria-labelledby="compRentadosModalLabel" aria-hidden="true">
        <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
    ...
    <!-- Modal -->
    <div class="modal fade" id="compPropiosModal" tabindex="-1" aria-labelledby="compPropiosModalLabel" aria-hidden="true">
        <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
    ...
    <!-- Modal Impresoras -->
    <!-- Modal -->
    <div class="modal fade" id="impresorasModal" tabindex="-1" aria-labelledby="impresorasModalLabel" aria-hidden="true">
        <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
    ...
    <!-- Modal Monitores -->
    <!-- Modal -->
    <div class="modal fade" id="monitoresModal" tabindex="-1" aria-labelledby="monitoresModalLabel" aria-hidden="true">
        <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
