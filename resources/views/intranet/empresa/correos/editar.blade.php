...
@section('cuerpo_pagina')
    <div class="card">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('correos-actualizar', ['id' => $correos->id]) }}" class="form-horizontal" method="POST">
            @csrf
            @method('put')
            <div class="card-body">
                @include('intranet.empresa.correos.form')
            </div>
            <!-- /.card-body -->
...
@section('scripts_pagina')
    ...
    <script src="{{ asset('js/intranet/empresa/correos/editar.js') }}"></script>
@endsection
<!-- ************************************************************* -->
