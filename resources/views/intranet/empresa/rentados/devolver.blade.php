        ...
        <div class="card-header">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6 text-md-left text-lg-left pl-2">
                    <h5>Devolver equipo al proveedor</h5>
                </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card card-primary card-outline direct-chat direct-chat-primary shadow-none">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6 text-right"><strong>Fecha de recepción del proveedor:</strong></div>
                                    <div class="col-6">{{$equipo->fecha_entrega}}</div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">{{$equipo->meses_uso}} meses</div>
                                </div>
                                <div class="row">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="row">
                            <div class="col-12 text-center">
                                <h6>Formulario devolución de equipo</h6>
                            </div>
                        </div>
                        <form action="{{ route('devolver_asignado_proveedor_devolver', ['id' => $equipo->id]) }}" class="form-horizontal" method="post">
                            @csrf
                            @method('post')
                            <div class="row">
                                <div class="col-12 col-md-5">
                                    <div class="form-group">
                                        <label for="codigo" class="control-label requerido">Fecha Devolución</label>
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary btn-sombra btn-xs pl-5 pr-5" type="submit">Devolver</button>
                                </div>
                            </div>
                        </form>
                    </div>
